                            ...
                            <table id="example1" class="mt-2 table">
                                ...
                                <thead>
                                    ...
                                    @foreach ($agentBill as $bill)
                                        <tr>
                                            <td colspan="3"><b>Customer Name</b>: {{ $bill->farmer->first_name }}
                                                {{ $bill->farmer->last_name }}</td>
                                            <td colspan="2"><b>Mobile</b>: {{ $bill->farmer->contact ? $bill->farmer->contact : "9797978585" }}</td>
                                        </tr>
                                        <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5" style="text-align: end">Commissions: {{ intval($bill->bill_amount) - intval($bill->total_amount) }}</td>
