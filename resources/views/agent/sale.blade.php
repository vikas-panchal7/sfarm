            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="d-flex justify-content-end p-3">
                        <div class="col-lg-4">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addFarmerModal">New Customer</button>
                        </div>
                    </div>
                   
                    <div class="card p-3">
                        <form id="block-validate" method="post" action="/agent/sale">
                            @csrf
                            <input type="hidden" value="{{ session('user_id') }}" name="agent_id">
                            <div class="form-group" style="display: flex;">
                                <label class="control-label col-lg-4">Select Customer</label>
                                <div class="col-lg-4">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addFarmerModalLabel">Add Customer</h5>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="block-validate" method="post" action="/addfarmer"
                        ...
                        @csrf
                        <input type="hidden" name="txt_ut" value="2" />
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="saveFarmerBtn">Save Customer</button>
            </div>
        </form>
        </div>
    </div>
