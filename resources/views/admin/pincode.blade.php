                            ...
                            <div class="form-group" style="display: flex;">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" id="pincode" name="pincode"
                                        placeholder="Enter pincode" pattern="[0-9]{6,6}" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" required>
                                </div>
                                <h6 style="color:red ; font-size:15px">@error('pincode'){{$message}}@enderror</h6>
                                        ...
                                        <form method="post" action="/pincode/update/{{ $pincode->id }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="edit_pincode"
                                                    name="pincode" value="{{ $pincode->pincode }}" pattern="[0-9]{6,6}" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" required> <br>
                                                    <h6 style="color:red ; font-size:15px">@error('pincode'){{$message}}@enderror</h6>
                                            </div>
                                            <div class="form-group">
