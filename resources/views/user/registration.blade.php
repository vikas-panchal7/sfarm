...
<div class="content-wrapper">
    ...
    <div class="container row m-auto" style="width: 100%">
        <div class="col-12">
            <div class="panel panel-default ">
                <div class="panel-body">

                    <form class="form-horizontal" id="block-validate" method="post" action="/userregistration"
                        ...
                        <div class="form-actions no-margin-bottom" style="text-align:center;">
                            <input type="submit" value="Submit" class="btn btn-primary btn-lg mb-5" name="btn_submit">
                        </div>
