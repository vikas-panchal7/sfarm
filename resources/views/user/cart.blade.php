                            ...
                            <tbody>
                                @foreach ($carts as $cart)
                                    <tr class="text-center">
                                        ...
                                        <td class="total"><i class="fa fa-rupee"></i>{{ $cart->total_price }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
<script>
    $(document).ready(function() {
        ...
        function updateCartTotals() {
            ...
            // Update subtotal
            $('#subtotal').html('<i class="fa fa-rupee"></i>' + subtotal.toFixed(2));
            ...
            // Update total
            $('#total').html('<i class="fa fa-rupee"></i>' + total.toFixed(2));
        }
